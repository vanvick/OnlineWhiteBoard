...
#include "common/base/arm_instruction_set_select.h"

// ThreadSanitizer provides own implementation of atomicops.
#if defined(THREAD_SANITIZER)
#include "common/google/atomicops-internals-tsan.h"
#elif defined(__APPLE__)
#include "common/google/atomicops-internals-macosx.h"
#elif defined(__GNUC__) && defined(ARMV6)
#include "common/google/atomicops-internals-arm-v6plus.h"
#elif defined(ARMV3)
#include "common/google/atomicops-internals-arm-generic.h"
#elif defined(__GNUC__) && (defined(__i386) || defined(__x86_64__))
#include "common/google/atomicops-internals-x86.h"
#elif defined(__GNUC__) && defined(ARCH_POWERPC64)
#include "common/google/atomicops-internals-powerpc.h"
#elif defined(OS_WINDOWS)
#include "common/google/atomicops-internals-windows.h"
#else
