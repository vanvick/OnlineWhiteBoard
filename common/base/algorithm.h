...
#ifndef COMMON_BASE_ALGORITHM_H_
#define COMMON_BASE_ALGORITHM_H_
...
inline std::pair<ForwardIter, ForwardIter> minmax_element(ForwardIter first,
  ...
  return common::base::minmax_element(first, last, std::less<value_type>());
}
...
inline bool is_sorted(ForwardIterator first, ForwardIterator last) {
  ...
  return common::base::is_sorted(first, last, std::less<value_type>());
}
...
inline bool is_partitioned(ForwardIterator first, ForwardIterator last,
  ...
  for (; first != last; ++first) {
    if (!pred(*first)) {
      ++first;
      return common::base::none(first, last, pred);
    }
  }
  return true;
}
...
#endif  // COMMON_BASE_ALGORITHM_H_
