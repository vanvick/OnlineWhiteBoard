...
#ifndef COMMON_BASE_HASH_STRING_HASH_H_
#define COMMON_BASE_HASH_STRING_HASH_H_

#include <stddef.h>

#include "common/base/port.h"
#include "common/base/integral_types.h"
#include "common/base/hash/city.h"
#include "common/base/hash/jenkins.h"
#include "common/base/hash/jenkins_lookup2.h"
...
inline size_t HashStringThoroughlyWithSeed(const char* s, size_t len,
  ...
  if (hash_internal::x86_64)
    return static_cast<size_t>(common::base_hash::CityHash64WithSeed(s, len, seed));
...
inline size_t HashStringThoroughly(const char* s, size_t len) {
  if (hash_internal::x86_64)
    return static_cast<size_t>(common::base_hash::CityHash64(s, len));
...
inline size_t HashStringThoroughlyWithSeeds(const char* s, size_t len,
  ...
  if (hash_internal::x86_64)
    return common::base_hash::CityHash64WithSeeds(s, len, seed0, seed1);
...
#endif  // COMMON_BASE_HASH_STRING_HASH_H_
