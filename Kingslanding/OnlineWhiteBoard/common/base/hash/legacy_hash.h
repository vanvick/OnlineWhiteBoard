...
#ifndef COMMON_BASE_HASH_LEGACY_HASH_H_
#define COMMON_BASE_HASH_LEGACY_HASH_H_

#include "common/base/integral_types.h"
#include "common/base/hash/builtin_type_hash.h"
...
#endif  // COMMON_BASE_HASH_LEGACY_HASH_H_
