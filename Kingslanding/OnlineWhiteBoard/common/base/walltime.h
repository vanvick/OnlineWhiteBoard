...
// of Supersonic.
#ifndef COMMON_BASE_TIMER_WALLTIME_H_
#define COMMON_BASE_TIMER_WALLTIME_H_
...
#include "common/base/cycleclock-inl.h"  // inline method bodies
#endif  // COMMON_BASE_TIMER_WALLTIME_H_
