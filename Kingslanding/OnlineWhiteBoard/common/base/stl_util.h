...
#ifndef COMMON_BASE_STL_UTIL_H_
#define COMMON_BASE_STL_UTIL_H_
...
void STLSetDifference(const SortedSTLContainerA &a,
  ...
  assert(common::base::is_sorted(a.begin(), a.end()));
  assert(common::base::is_sorted(b.begin(), b.end()));
...
bool SortedRangesHaveIntersection(InputIterator1 begin1, InputIterator1 end1,
  ...
  assert(common::base::is_sorted(begin1, end1));
  assert(common::base::is_sorted(begin2, end2));
...
bool SortedRangesHaveIntersection(InputIterator1 begin1, InputIterator1 end1,
                                  InputIterator2 begin2, InputIterator2 end2,
                                  Comp comparator) {
  assert(common::base::is_sorted(begin1, end1, comparator));
  assert(common::base::is_sorted(begin2, end2, comparator));
  while (begin1 != end1 && begin2 != end2) {
