...
//     Split() API.
//
#ifndef COMMON_BASE_STRINGS_SPLIT_H_
#define COMMON_BASE_STRINGS_SPLIT_H_
...
#include "common/base/strings/split_internal.h"
#include "common/base/strings/stringpiece.h"
#include "common/base/strings/strip.h"
...
bool SplitStringAndParseToInserter(
  ...
  bool retval = true;
  vector<StringPiece> pieces = common::strings::Split(
          source,
          common::strings::delimiter::AnyOf(delim),
          common::strings::SkipEmpty());
...
#endif  // COMMON_BASE_STRINGS_SPLIT_H_
