...
#ifndef COMMON_BASE_STRINGS_ESCAPING_H_
#define COMMON_BASE_STRINGS_ESCAPING_H_
...
#include "common/base/strings/ascii_ctype.h"
#include "common/base/strings/charset.h"
#include "common/base/strings/stringpiece.h"
...
using common::strings::EscapeStrForCSV;
using common::strings::UnescapeCEscapeSequences;
using common::strings::UnescapeCEscapeString;
using common::strings::CEscapeString;
using common::strings::CHexEscapeString;
using common::strings::CEscape;
using common::strings::CHexEscape;
using common::strings::BackslashEscape;
using common::strings::BackslashUnescape;
using common::strings::QuotedPrintableUnescape;
using common::strings::QEncodingUnescape;
using common::strings::Base64Unescape;
using common::strings::WebSafeBase64Unescape;
using common::strings::CalculateBase64EscapedLen;
using common::strings::Base64Escape;
using common::strings::WebSafeBase64Escape;
using common::strings::WebSafeBase64EscapeWithPadding;
using common::strings::Base32Escape;
using common::strings::Base32HexEscape;
using common::strings::CalculateBase32EscapedLen;
using common::strings::EightBase32DigitsToTenHexDigits;
using common::strings::TenHexDigitsToEightBase32Digits;
using common::strings::EightBase32DigitsToFiveBytes;
using common::strings::FiveBytesToEightBase32Digits;
using common::strings::int_to_hex_digit;
using common::strings::int_to_lower_hex_digit;
using common::strings::hex_digit_to_int;
using common::strings::a2b_hex;
using common::strings::a2b_bin;
using common::strings::b2a_hex;
using common::strings::b2a_bin;
using common::strings::ShellEscape;
using common::strings::ShellEscapeCommandLine;
using common::strings::ByteStringFromAscii;
using common::strings::ByteStringToAscii;
using common::strings::CleanStringLineEndings;

#endif  // COMMON_BASE_STRINGS_ESCAPING_H_
