...
//
#ifndef COMMON_BASE_STRINGS_JOIN_H_
#define COMMON_BASE_STRINGS_JOIN_H_
...
#include "common/base/strings/strcat.h"    // For backward compatibility.
...
#endif  // COMMON_BASE_STRINGS_JOIN_H_
