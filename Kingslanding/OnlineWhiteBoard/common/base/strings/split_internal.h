...
#ifndef COMMON_BASE_STRINGS_SPLIT_INTERNAL_H_
#define COMMON_BASE_STRINGS_SPLIT_INTERNAL_H_
...
#include "common/base/port.h"  // for LANG_CXX11
...
#pragma GCC diagnostic pop
 ...
 private:
  ...
  struct is_map {
    template <typename U>
    static common::base::big_ test(typename U::mapped_type*);

    template <typename>
    static common::base::small_ test(...);

    static const bool value =
        (sizeof(test<T>(0)) == sizeof(common::base::big_));
  };
...
#endif  // COMMON_BASESTRINGS_SPLIT_INTERNAL_H_
