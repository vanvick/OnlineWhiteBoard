...
#ifndef COMMON_BASE_STRINGS_MEMUTIL_H_
#define COMMON_BASE_STRINGS_MEMUTIL_H_

#include <stddef.h>
#include <string.h>      // to get the POSIX mem*() routines

#include "common/base/port.h"   // disable some warnings on Windows
...
#endif  // COMMON_BASE_STRINGS_MEMUTIL_H_
