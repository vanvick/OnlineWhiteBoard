...
#define GOOGLE_HAVE_PTHREAD
#define GOOGLE_HAVE_RWLOCK
...
#elif defined(GOOGLE_HAVE_PTHREAD) && defined(GOOGLE_HAVE_RWLOCK)
...
#elif defined(GOOGLE_HAVE_PTHREAD)
# include <pthread.h>
...
#include "common/google/thread_annotations.h"
