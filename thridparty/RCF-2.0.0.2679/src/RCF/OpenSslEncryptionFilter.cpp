...
namespace RCF {
    ...
    class OpenSslCryptoDll : DynamicLib
    {
    public:
        OpenSslCryptoDll();
    ...
    OpenSslDll::OpenSslDll() : DynamicLib( 
        getGlobals().getOpenSslDllName() )
    {
        loadFunctionPtrs();
    ...
    OpenSslCryptoDll::OpenSslCryptoDll() : 
        DynamicLib( getGlobals().getOpenSslCryptoDllName() )
    {
        loadFunctionPtrs();
